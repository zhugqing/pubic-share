        ...
        showChart(){
            ...
            G6.registerNode('sub', {
                ...
                setState(name, value, item) {
                    if (name === "collapsed") {
                        ...
                        const label = item.get("group").findAll(ele => ele.get("name") === "sub-keyShape");
                        label[0].attr('stroke',value ?'rgba(255,255,255,0.4)':'rgba(255, 255, 255, 0)')
                        label[0].attr('fill',value ?'rgba(255, 255, 255, 0.3)':'rgba(255, 255, 255, 0.2)')
                        label[0].attr('shadowBlur',value ?10:0)
                        label[0].attr('shadowColor',value ?'rgba(26,90,170,0.8)':'rgba(255, 255, 255, 0)')
                    }
                },
                update: undefined,
            }, 'rect')
            ...
            G6.registerNode('leaf', {
                ...
                setState(name, value, item) {
                    if (name === "collapsed") {
                        ...
                        const label = item.get("group").findAll(ele => ele.get("name") === "leaf-keyShape");
                        label[0].attr('stroke',value ?'rgba(255,255,255,0.4)':'rgba(255, 255, 255, 0)')
                        label[0].attr('fill',value ?'rgba(255, 255, 255, 0.3)':'rgba(255, 255, 255, 0.2)')
                        label[0].attr('shadowBlur',value ?10:0)
                        label[0].attr('shadowColor',value ?'rgba(26,90,170,0.8)':'rgba(255, 255, 255, 0)')
           ...
           this.tree.on('node:click', (e) => {
                if(e.target.get('name') == 'collapse-icon'){
                    ...
                    this.tree.setItemState(e.item, "collapsed", !e.item.getModel().collapsed);
                    this.tree.layout();
                }
            });
