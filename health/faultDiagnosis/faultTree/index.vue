    ...
    <BaseLayout v-if="keyWord ==1">
      ...
      <template #content>
        <div class="wrapper">
          ...
          <MainContent @faultTreeBDetail="faultTreeBDetail"></MainContent>
        </div>
      </template>
    </BaseLayout>
    <TreeEditAdd v-if="keyWord ==2" @pageBack="pageBack"></TreeEditAdd>
  </div>
</template>
...
import TreeEditAdd from './components/treeEditAdd.vue'
  ...
  treeData: [
    {
      ...
      type: 1,
      children: [
        { id: 1, label: 'DEW-D2.0-87', type: 2 },
        { id: 2, label: 'DEW-D2.0-87', type: 2 },
        { id: 3, label: 'DEW-D2.0-87', type: 2 },
        { id: 4, label: 'DEW-D2.0-87', type: 2 },
        { id: 5, label: 'DEW-D2.0-87', type: 2 },
        { id: 6, label: 'MySE3.6-135', type: 2 },
      ]
    }
  ]
})
